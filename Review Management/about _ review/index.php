...
mysqli_close($con);
?></h3>
      <form action="http://localhost/Retro_cafe/admin%20all%20page/Review%20Management/about%20_%20review/deletereview.php" method="post">
          <input type="numeric" name="id" placeholder="Review ID?">
